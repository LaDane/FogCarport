...
public class CarportCalculator {
    ...
    public static List<OrderLine> calculateCarport(Carport carport) {
    ...
    public static double getRafterLysViddeTrapez(double width) {
        double distanceFromRemToEdge = 39.5;
        return width - (distanceFromRemToEdge * 2);
    }

    public static double getRafterHeightFromLysVidde(double lysVidde) {
    ...
    public static int getAmountOfRaftersTrapez(double length, double rafterDistance) {
        return (int)Math.ceil(length / rafterDistance) + 1;
    }

    public static double getDistanceRafters(double lysvidde, double raftHeight, double length) {
    ...
    public static int getAmountTrapezRow(double length) {
        int amount = 1;
        if (length > 570)
            amount = 2;
        return amount;
    ...
    public static int getLengthOfTrapez(double length) {
        int buffer = 20;
    ...
    public static int getAmountOfTrapezAcross(double width) {
        return (int) Math.ceil(width / 100);
    }

    public static int getTotalAmountOfTrapez(double length, double width) {
